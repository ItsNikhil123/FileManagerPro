...
# Your code using regular expressions comes here
...
win1=Tk()
win1.title("Carousel File explorer by Devatha Nikhil")

favicon=ImageTk.PhotoImage(Image.open("images/badge.jpg"))
...
can1=Canvas(width=usedWidth,height=usedHeight,highlightthickness=0,scrollregion=(0,0,usedWidth,usedHeight),bg="gray64",)
can1.pack()
...
can2=Canvas(width=usedWidth/6,heigh=usedHeight/4,highlightthickness=0,bg="PaleVioletRed2")
can2.place(x=0,y=usedHeight/10)
...
def RootFunction(CurrentDir):
    if system=="Windows":
        ...
        OpenFile("/",True)
RootText=can2.create_text(usedWidth/12,52,text="Root",anchor=CENTER,fill="white",)
...
def MediaFunction(CurrentDir):
    ...
    if system=="Windows":
        OpenFile("C:/Users"+"/"+str(getuser())+"/"+"Videos", True)
    else:
        OpenFile("/home"+"/"+str(getuser())+"/"+"Videos",True)
MediaText=can2.create_text(usedWidth/12,72,text="Media",anchor=CENTER,fill="white")
...
DesktopText=can2.create_text(usedWidth/12,112,text="Desktop", anchor=CENTER,fill="white")
...
can3=Canvas(width=usedWidth/6-2,height=usedHeight/15,highlightthickness=0,bg="PaleVioletRed2",)
can3.place(x=0,y=8)
...
but1=Button(can3,image=icon_reload,width=60,height=40,bd=0,bg="black",activebackground="white",command=Reload)
but1.place(x=1,y=5)
but2=Button(can3,image=icon_backward,width=60,height=40,bd=0,bg="black",activebackground="white",command=GoBack)
but2.place(x=(usedWidth/6-3)/100*30,y=5)
but3=Button(can3,image=icon_forward,width=60,height=40,bd=0,bg="black",activebackground="white")
but3.place(x=(usedWidth/6-3)/8*5,y=5)

scrollbar1.config(command=can1.yview)
can1['yscrollcommand']=scrollbar1.set

icon0=ImageTk.PhotoImage(Image.open("images/Folder.png"))
...
icon3=ImageTk.PhotoImage(Image.open("images/Txt.png"))
...
icon7=ImageTk.PhotoImage(Image.open("images/audio.png"))
...
icon12=ImageTk.PhotoImage(Image.open("images\PPtx.png"))
icon13=ImageTk.PhotoImage(Image.open("images\Xlsx.png"))
icon14=ImageTk.PhotoImage(Image.open("images\Docx.png"))
...
def ViewFolder(dossier):
    ...
    RectangleFiles=can1.create_rectangle(0,0,usedWidth,usedHeight*15,fill="grey99")
    ...
    for i in lstDir:
        ...
        if currentWidthIconPlacement<maxWidthIconPlacement:
            ...
            if extFile==".txt" and hidden==0:
                ...
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
                ...
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+80.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
                ...
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".pptx" and hidden==0:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon12)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".pptx"  and hidden==1:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon11_hid)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".xlsx"  and hidden==0:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon13)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".xlsx"  and hidden==1:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon11_hid)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".docx"  and hidden==0:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon14)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            elif extFile==".docx"  and hidden==1:
                icon=can1.create_image(currentWidthIconPlacement+37.5,currentHeightIconPlacement+37.5,image=icon11_hid)
                lab1=can1.create_text(currentWidthIconPlacement+37.5,currentHeightIconPlacement+87.5,text=i2,fill="black",width=75,justify=CENTER)
                IsDirectory=False
            else:
